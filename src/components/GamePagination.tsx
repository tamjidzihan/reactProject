...
function GamePagination({ onNextPage, onPreviousPage }: Props) {


    return (
        <Stack spacing={4} direction='row' justify='center' padding='20px'>

            <Button onClick={onPreviousPage} boxShadow={" rgba(17, 12, 46, 0.15) 0px 50px 100px -20px"} width={'4rm'}>
                <ChevronLeftIcon fontSize='xxx-large' cursor='pointer' />
            </Button>


            <Button onClick={onNextPage} boxShadow={" rgba(17, 12, 46, 0.15) 0px 50px 100px -20px"} width={'4rm'}>
